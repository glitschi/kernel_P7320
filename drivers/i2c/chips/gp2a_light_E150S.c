...
/*
...
#ifdef CONFIG_ARCH_MSM8X60
	l9 = regulator_get(NULL, "8058_l11");
	...
	rt = regulator_disable(l9);

	if (rt) {
		pr_err("%s: L11 vreg disable failed (%d)\n",
			   __func__, rt);
		regulator_put(l9);
		return rt;
	}
...
/*
	...
	rt = regulator_set_voltage(l9, 2850000, 2850000);
