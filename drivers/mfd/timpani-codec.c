...
/*
 remove array overrun possibility : timpani_regset size : 177
 Do modify 177 after changing timpani_regset size
*/
#define TIMPANI_REGSET_ARRAY_SIZE 177	//boot exception
...
//remove array overrun possibility :0xEF -> TIMPANI_REGSET_ARRAY_SIZE		for (i = 0; i < 0xEF; i++) {	//boot exception
	for (i = 0; i < TIMPANI_REGSET_ARRAY_SIZE ; i++) {
