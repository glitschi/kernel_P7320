...
#if defined(CONFIG_TARGET_LOCALE_USA_ATT) || defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_KT) || defined(CONFIG_TARGET_LOCALE_KOR_LGU) || defined(CONFIG_TARGET_LOCALE_EUR_OPEN)
#define USB_SEL_2	37
#endif 
...
{
	pr_info("%s\r\n", __func__);
#if defined(CONFIG_TARGET_LOCALE_USA_ATT) || defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_EUR_OPEN)
	if (system_rev == 0x01) {
		stmpe811_i2c_gpio_data.scl_pin = GPIO_ADC_SCL_OLD;
		stmpe811_i2c_gpio_data.sda_pin = GPIO_ADC_SDA_OLD;		
	} 
#elif defined(CONFIG_TARGET_LOCALE_KOR_LGU)
	if (system_rev < 0x04){
		stmpe811_i2c_gpio_data.scl_pin = GPIO_ADC_SCL_OLD;
		stmpe811_i2c_gpio_data.sda_pin = GPIO_ADC_SDA_OLD;	
	}
...
#if defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_KT)
	.temp_high_threshold = 58500,
	.temp_high_recovery = 45200,
	.temp_low_recovery = 2500,
	.temp_low_threshold = -2000,
#else	// CONFIG_TARGET_LOCALE_KOR_LGU
...
static struct mxt_platform_data p3_touch_platform_data = {
	...
	/*Atmel: 50 -> 6-> 20->50(to avoid  calibration repetition lockup)*/
	.acquisition_config.atchcalfrcthr = 50,
	/*180=>0=>25(to avoid  calibration repetition lockup)*/
	.acquisition_config.atchcalfrcratio = 25,
	/*multitouch_config*/
	...
	.touchscreen_config.mrgthr = 5,/*Atmel 20 -> 5*/
...
static const struct i2c_board_info sec_i2c_touch_info[] = {
	{
#if defined(CONFIG_TARGET_LOCALE_USA_ATT) || defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_LGU) || defined(CONFIG_TARGET_LOCALE_EUR_OPEN)
...
#if defined(CONFIG_TARGET_LOCALE_USA_ATT) || defined(CONFIG_TARGET_LOCALE_EUR_OPEN) 
	.sdi_capacity = 0x3138, //6300*2
	.sdi_vfcapacity = 0x41A0, //8400*2
#elif defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_KT) || defined(CONFIG_TARGET_LOCALE_KOR_LGU)
...
#elif defined(CONFIG_TARGET_LOCALE_KOR_SKT)
	if(system_rev < 0x07){ 
...
static struct rpm_vreg_pdata rpm_vreg_init_pdata[RPM_VREG_ID_MAX] = {
...
#else
	RPM_VREG_INIT_LDO(PM8058_L8,  0, 1, 0, 1800000, 2900000, LDO300HMIN, 0),
#endif

#if defined(CONFIG_TARGET_LOCALE_USA_ATT) || defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_LGU) || defined(CONFIG_TARGET_LOCALE_EUR_OPEN)
	RPM_VREG_INIT_LDO(PM8058_L9,  0, 1, 0, 1500000, 3000000, LDO300HMIN, 0),
#else
	...
	RPM_VREG_INIT_LDO(PM8058_L20, 0, 1, 0, 1800000, 3000000, LDO150HMIN, 0),
#else	
...
#if defined(CONFIG_TARGET_LOCALE_KOR_SKT) || defined(CONFIG_TARGET_LOCALE_KOR_KT)
	RPM_VREG_INIT_LDO(PM8901_L5,  0, 1, 0, 2850000, 2950000, LDO300HMIN, 0),
#else
...
#endif	
#ifndef CONFIG_TARGET_LOCALE_KOR_LGU
...
struct pm8058_gpio main_micbiase = {
		.direction      = PM_GPIO_DIR_IN,
		.pull           = PM_GPIO_PULL_NO,
		.vin_sel        = 2,
		.function       = PM_GPIO_FUNC_NORMAL,
...
#ifdef CONFIG_TARGET_LOCALE_KOR_LGU
...
MACHINE_START(SAMSUNG_P5_LTE, "Samsung P5 LTE")
